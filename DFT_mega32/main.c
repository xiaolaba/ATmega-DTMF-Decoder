// ref https://blog.vinu.co.in/2012/05/implementing-discrete-fourier-transform.html
// compliation, xioalaba, 2013
// avr-gcc
...
{
    uint8_t mag;
    //int i,j, temp_value; // unused variable
    int i;
    //uint8_t temp_index; // unused variable
    adc_init();
    lcd_init();
    lcd_fill_custom();
